  ...
  return (
    <Routes>
      <Route path="/" element={<Html />}>
        ...
        <Route path='/les3' element={HtmlDocumenеТhird.map(doc => (
          <Lesson3 key={doc.id} title={doc.title} content={doc.content} />
        ))}/>
        
        <Route path='/les4' element={HtmlDocumentFourth.map(doc => (
          <Lesson4 key={doc.id} title={doc.title} content={doc.content} />
        ))}/>
        
        <Route path='/les5' element={HtmlDocumentFifth.map(doc => (
          <Lesson5 key={doc.id} title={doc.title} content={doc.content} />
        ))}/>
        
        <Route path='/les6' element={HtmlDocumentSixth.map(doc => (
          <Lesson6 key={doc.id} title={doc.title} content={doc.content} />
        ))}/>

        <Route path='/les7' element={HtmlDocumentSeventh.map(doc => (
          <Lesson7 key={doc.id} title={doc.title} content={doc.content} />
        ))}/>

        <Route path='/les8' element={HtmlDocumentEighth.map(doc => (
          <Lesson8 key={doc.id} title={doc.title} content={doc.content} />
        ))}/>

        <Route path='/les9' element={HtmlDocumentNinth.map(doc => (
          <Lesson9 key={doc.id} title={doc.title} content={doc.content} />
        ))}/>

        <Route path='/les10' element={HtmlDocumentTenth.map(doc => (
          <Lesson10 key={doc.id} title={doc.title} content={doc.content} />
        ))}/>

        <Route path='/les11' element={HtmlDocumentEleventh.map(doc => (
