...
function Css() {
  ...
  const handleSearch = (term) => {
      setSearchTerm(term);
      const filteredResults = [...CssDocumentFirst, ...CssDocumentSecond, ...CssDocumentТhird, ...CssDocumentFourth, ...CssDocumentFifth, ...CssDocumentSixth, ...CssDocumentSeventh, ...CssDocumentEighth, ...CssDocumentNinth, ...CssDocumentTenth, ...CssDocumentEleventh].filter(doc => 
